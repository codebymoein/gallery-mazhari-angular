...
| GM-004 | EPIC-05 | Bespoke services journey for custom veil/dress consultation, photo-led request entry points and Tehran fitting-at-home discovery | L3 | P1 | ACCEPTANCE | Implementation and local browser/SSR evidence complete; exact-head CI/merge pending; upload, map, deposit and submission semantics remain unchanged |
