...
| GM-006 | EPIC-01 | Storefront motion language: reveal, image drift, chapter transitions and gesture polish without scroll hijacking | L2 | P2 | IN_PROGRESS | Home motion foundation active on `feat/gm-006-home-motion-foundation`; CSS-only finite transforms, no third-party animation dependency; reduced-motion required |
