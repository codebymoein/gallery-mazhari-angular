...
| GM-031 | EPIC-01 | Refine the mobile header wordmark, icon controls, drawer transition and submenu reveal motion | L2 | P1 | IN_PROGRESS | Owner-requested mobile-only polish; extends GM-008 without changing navigation semantics, routes, catalog authority or desktop composition |
