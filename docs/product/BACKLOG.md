...
| GM-040 | EPIC-01 | Reference-led mobile drawer with physical-left entry, minimal hairline rows, accordion motion and flat taupe CTA | L2 | P1 | ACCEPTANCE | Implementation and exact-head automated evidence complete in PR #109; manual mobile visual/product acceptance pending; existing navigation/search/cart semantics and desktop mega-menu preserved |
