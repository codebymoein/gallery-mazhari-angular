...
| GM-032 | EPIC-01 | Refine the mobile header wordmark, icon controls, drawer transition and submenu reveal motion | L2 | P1 | DONE | Delivered on `main`; later storefront Header decisions are governed by GM-041/042. |
| GM-039 | EPIC-01 | Fashion-editorial Home opening with full-width bridal hero and paired bridal/accessory store entries | L2 | P1 | DONE | Merged via PR #108, then intentionally superseded by the GM-042 five-slide Hero. |
| GM-040 | EPIC-01 | Reference-led mobile drawer redesign | L2 | P1 | REJECTED | PR #109 closed without merge; the approved GM-041/042 implementation superseded this branch and scope. |
| GM-041 | EPIC-01 | Monochrome storefront foundation, shared responsive Header and NgRx-backed cart indicator | L2 | P1 | DONE | Phase 1 merged via PR #110; acceptance reconciliation merged via PR #111. |
| GM-042 | EPIC-01 | Storefront Redesign Phase 2: Home experience, Hero and Header interaction polish | L2 | P1 | DONE | Seven-checkpoint Phase 2 merged via PR #113 and accepted by the owner before Phase 3 work began. |
| GM-043 | EPIC-01 | Expandable trust stories for the Home trust strip | L2 | P1 | DONE | Merged via PR #117 with the existing Home trust structure and storefront boundaries preserved. |
