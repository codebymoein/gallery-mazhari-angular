...
| GM-039 | EPIC-01 | Fashion-editorial Home opening with full-width bridal hero and paired bridal/accessory store entries | L2 | P1 | ACCEPTANCE | Merged via PR #108; its static opening is intentionally superseded by the GM-042 five-slide Hero without duplicating the Home opening. |
| GM-041 | EPIC-01 | Monochrome storefront foundation, shared responsive Header and NgRx-backed cart indicator | L2 | P1 | ACCEPTANCE | Owner-approved six-checkpoint Phase 1 on `feat/storefront-redesign-phase-1-header`; fresh from `main`; GM-040 is reserved by overlapping open PR #109, which remains untouched and is not a branch dependency |
| GM-042 | EPIC-01 | Storefront Redesign Phase 2: Home experience, Hero and Header interaction polish | L2 | P1 | IN_PROGRESS | Owner-approved seven-checkpoint program on `feat/gm-042-storefront-redesign-phase-2`; Step 7 certification/documentation/PR active; manual visual acceptance and merge remain owner-gated. |
