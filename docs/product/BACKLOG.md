...
| GM-005 | EPIC-01 | Editorial category chapters and fashion-led mobile discovery instead of conventional card-grid presentation | L2 | P1 | IN_PROGRESS | Focused branch `feat/gm-005-editorial-catalog`; shared card and category/collection presentation only; catalog authority/filtering semantics and indexable routes preserved |
