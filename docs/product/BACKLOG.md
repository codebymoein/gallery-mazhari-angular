...
| GM-009 | EPIC-01 | Restore WCAG AA contrast for contact branch guidance text | L1 | P1 | IN_PROGRESS | Focused prerequisite unblocking the existing accessibility gate; replaces one hard-coded color with the semantic muted-text token |
