...
| GM-003 | EPIC-05 | Wedding Planner with ceremony/date setup, complete checklist, progress and contextual catalog/consultation actions | L3 | P1 | IN_PROGRESS | Active branch `feat/gm-003-wedding-planner`; PostgreSQL/NestJS authority; reuses existing customer auth |
