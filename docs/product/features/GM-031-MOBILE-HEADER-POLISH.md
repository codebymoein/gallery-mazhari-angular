...
- Dependencies / related items: extends the established GM-008 header and GM-001 motion-token foundation; unrelated GM-030 cleanup remains out of scope.
...
- The independent GM-030 dead-code PR.
...
- Browser/E2E: focused mobile header test plus existing critical/design-system/accessibility coverage.
...
## Recovery
- Code rollback/revert: revert the focused GM-031 PR.
...
## Delivery
- Planned branch: `feat/gm-031-mobile-header-polish`
- Planned PR: focused GM-031 PR against `main`
