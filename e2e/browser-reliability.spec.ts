...
test('storefront remains usable across the RM-13 browser matrix', async ({ page, context, browserName }, testInfo) => {
  ...
  if (testInfo.project.name === 'chromium-constrained' && browserName === 'chromium') {
