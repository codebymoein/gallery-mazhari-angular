...
export const PLANNER_TASK_CATALOG: readonly PlannerTaskDefinition[] = [
  {
    ...
    description: 'فرم لباس، حس مراسم و اولویت‌های اصلی را قبل از خریدهای بزرگ مشخص کنید.',
    group: 'foundation',
    daysBefore: 180,
  },
  {
    ...
    description: 'برای بررسی فرم، زمان‌بندی پرو و انتخاب مدل مناسب یک جلسه تخصصی رزرو کنید.',
    group: 'foundation',
    daysBefore: 150,
  ...
  },
  {
    ...
    description: 'مدل‌های مناسب را مقایسه و انتخاب اصلی را برای ادامه پروها نهایی کنید.',
    group: 'style',
    daysBefore: 120,
    ceremonyTypes: [CeremonyType.WEDDING, CeremonyType.AGHD, CeremonyType.FORMALITY],
  ...
  },
  {
    ...
    description: 'راحتی، ارتفاع کفش و هماهنگی زیورآلات با لباس را هم‌زمان بررسی کنید.',
    group: 'style',
    daysBefore: 60,
    action: { kind: 'catalog', target: 'accessories' },
  },
  ...
  },
  {
    ...
    description: 'اقلام ضروری کوچک برای لباس، آرایش و اکسسوری را از قبل کنار بگذارید.',
    group: 'final',
    daysBefore: 7,
  },
  {
    ...
    description: 'لباس، تور، کفش، اکسسوری و زمان تحویل را در یک مرور نهایی چک کنید.',
    group: 'final',
    daysBefore: 3,
  },
];
