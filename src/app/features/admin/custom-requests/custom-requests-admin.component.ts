...
export class CustomRequestsAdminComponent implements OnInit {
  ...
  requests: CustomRequestRecord[] = []; filter: 'all' | CustomRequestType = 'all'; monthFilter = 'all'; loading = true; error = '';
  ...
  label(type: CustomRequestType): string { return type === 'veil' ? 'تور سر سفارشی' : 'لباس سفارشی'; }
