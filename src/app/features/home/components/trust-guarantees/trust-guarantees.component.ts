  ...
  readonly items: TrustItem[] = [
    {
      id: 'heritage',
      label: 'از سال ۱۳۳۷',
      description: 'گالری مظهری از سال ۱۳۳۷ با نزدیک به هفت دهه تجربه تخصصی در حوزه عروس، همراه نسل‌های مختلف خانواده‌های ایرانی بوده است. فعالیت هم‌زمان به‌عنوان تولیدکننده و واردکننده، امکان انتخاب مستقیم، دقیق و مطمئن از میان محصولات اصیل و باکیفیت را فراهم کرده است. انتخاب گالری مظهری، انتخاب مجموعه‌ای باسابقه است که اهمیت و حساسیت جزئیات روز عروسی را می‌شناسد و اعتبار خود را بر پایه کیفیت، تخصص و اعتماد مشتریان بنا کرده است.'
    },
    {
      id: 'shopping',
