...
export class RealBridesComponent implements OnDestroy {
  ...
  private readonly defaultMoments: RealBrideMoment[] = [
    { id: '1', name: 'سارا م.', quote: 'عروس زیبای ما در عمارت؛ لحظه‌ای که لباس اروپایی با نور طلایی یکی شد.', venue: 'عمارت نیاوران', image: 'assets/images/home-hero-bride.webp', span: 'tall' },
    { id: '2', name: 'نیکا ر.', quote: 'تاج و تور، درست همان‌طور که در پرو VIP تصور کرده بودم.', venue: 'تالار باغ‌گل', image: 'assets/images/bridal-hair-accessories.webp', span: 'square' },
    { id: '3', name: 'مریم ک.', quote: 'از کت‌وشلوار عقد تا آخرین جزئیات — همه‌چیز هماهنگ و ماندگار.', venue: 'خانه عقد سعدی', image: 'assets/images/cat-bridal-clothing.webp', span: 'wide' },
    { id: '4', name: 'هستی پ.', quote: 'زیورآلات و حجاب مو، تکمیل‌کننده رویای سفید من بودند.', venue: 'عمارت فرشته', image: 'assets/images/cat-jewelry.webp', span: 'square' },
    { id: '5', name: 'آیدا ش.', quote: 'تور بلند و کفش درخشان؛ قدم‌هایی که تا همیشه به یاد می‌مانند.', venue: 'باغ‌سرای شمیران', image: 'assets/images/cat-veil.webp', span: 'tall' },
    { id: '6', name: 'یاسمن ف.', quote: 'دسته‌گل و اکسسوری خاص — جزئیاتی که استایلم را کامل کردند.', venue: 'تالار الماس', image: 'assets/images/cat-bouquet.webp', span: 'square' }
  ];
  ...
  next(): void {
    const i = this.activeIndex();
    if (i === null || !this.moments.length) return;
